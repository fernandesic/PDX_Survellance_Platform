                ...
                <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
                    ...
                    >
                        <div className="p-8">
                            <button
                                onClick={onClose}
                                className="absolute top-6 right-6 h-10 w-10 rounded-full bg-slate-50 flex items-center justify-center text-slate-400 hover:text-slate-900 transition-all z-10"
                            >
                                <X size={20} />
                            </button>
                                ...
                                <div className="space-y-3 w-full">
                                    <button
                                        ...
                                        className={`h-12 w-full rounded-xl flex items-center justify-center gap-2 text-white font-black text-[12px] uppercase tracking-[0.1em] transition-all
                                            ...
                                            ${disableConfirm ? 'opacity-50 cursor-not-allowed saturate-50' : ''}
                                            shadow-lg
                                        `}
                                    >
